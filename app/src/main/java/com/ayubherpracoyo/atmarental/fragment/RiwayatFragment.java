...
import com.ayubherpracoyo.atmarental.adapter.RiwayatAdapter;
import com.ayubherpracoyo.atmarental.api.TransaksiApi;
import com.ayubherpracoyo.atmarental.databinding.FragmentRiwayatBinding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState)
    {
        ...
        binding.btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ((MainActivity)getActivity()).changeFragment(new TransaksiFragment());
            }
        });
        ...
        adapter = new RiwayatAdapter(new ArrayList<>(), this.getContext());
    ...
    private void getAllRiwayat() {
        StringRequest stringRequest = new StringRequest(GET, TransaksiApi.GET_ALL_URL, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                adapter.setRiwayatList(transaksiResponse.getTransaksiList(), userPreferences.getUserLogin());
